...
abstract public class DCommand implements Runnable, Callable<DRecord> {
    ...
    */
    ...
    protected void markStatus(DRecord.Status status) throws DSiteException {
        assert record != null;
    ...
    protected void markProgress(float progress) throws DSiteException {
        assert record != null;
    ...
    public void run() {
        ...
        try {
            ...
            } catch (DSiteException e1) {
                throw new DRuntimeException(e1);
            }
        } catch (DSiteException e) {
            // since it's already DSiteException, it makes no sense to markStatus again.
     ...
     */
    abstract protected void execute() throws DCommandExecutionException, DSiteException;

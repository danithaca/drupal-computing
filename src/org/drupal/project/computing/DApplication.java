...
abstract public class DApplication {
    ...
    private void runSequential() throws DRuntimeException, DSiteException {
        assert commandRegistry != null;
        List<DRecord> records = drupalSite.queryReadyRecords(getIdentifier());
    ...
    private void runParallel() throws DRuntimeException, DSiteException {
    ...
    private void runCli() throws DSiteException, DRuntimeException {
        assert commandRegistry != null;
        ...
        drupalSite.createRecord(record);
    }

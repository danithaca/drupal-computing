 ...
 *
 * @deprecated
 *   Don't use direct database access, because then there's no way to access the Drupal logic before handling data.
 *   This will cause more problems later.
 */
public class DSqlSite extends DSite {
    ...
    /*public DSqlSite() throws DConfigException, DSiteException {
        this(new DDatabase(new DConfig().getDbProperties()));
    }

    public DSqlSite(DConfig config) throws DConfigException, DSiteException {
    ...
    public String getDrupalVersion() throws DSiteException {
        ...
        if (version != null) {
            ...
            throw new DSiteException("Cannot get Drupal version. Possible reason: computing module not installed.");
        }
    }

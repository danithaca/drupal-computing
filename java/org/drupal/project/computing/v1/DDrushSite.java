...
public class DDrushSite extends DSite {
    ...
    public DDatabase getDatabase() throws DConnectionException {
        ...
        try {
            ...
            throw new DConnectionException("Cannot get database connection to Drupal with drush. Please read documentations.", e);
        }
    }
    ...
    public static class UnitTest {
        ...
        @Test
        public void testLoad() throws DConnectionException {
            //DRecord r1 = site.loadRecord(6);
            //System.out.println(r1.toString());
            List<DRecord> records = site.queryActiveRecords("common");
        ...
        @Test
        public void testUpdate() throws DConnectionException {
            DRecord r0 = createRecord();
        ...
        @Test
        public void testVariable() throws DConnectionException {
